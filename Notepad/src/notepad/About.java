...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        JLabel l3 = new JLabel("<html>this project is made by vikalp sharma 181110106076 <br> ubaid ansari 181110106073<br> on dated 2021-01-03 <br> Meerut institute of technology<br><br>Notepad is a word processing program, <br>which allows changing of text in a computer file.<br>Notepad is a simple text editor for basic text-editing program<br> which enables computer users to create documents. </html>");
